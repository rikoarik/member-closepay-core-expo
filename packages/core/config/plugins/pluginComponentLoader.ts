...
const STATIC_COMPONENT_LOADERS: Record<string, Record<string, () => Promise<any>>> = {
  ...
  marketplace: {
    ...
    StoreProductSearchScreen: () => import('../../../plugins/marketplace/components/screens/StoreProductSearchScreen'),
    StoreProductSearchResultsScreen: () => import('../../../plugins/marketplace/components/screens/StoreProductSearchResultsScreen'),
    ...
    MapPickerScreen: () => import('../../../plugins/marketplace/components/screens/MapPickerScreen'),
  ...
  'marketplace-fnb': {
    ...
    FnBOrderFloatingWidget: () => import('../../../plugins/marketplace-fnb/components/widgets/FnBOrderFloatingWidget'),
  },
  payment: {
